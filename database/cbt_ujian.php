...
$tabel = "cbt_soal,cbt_jawaban,cbt_siswa_ujian,cbt_paketsoal,cbt_ujian,cbt_nilai,cbt_upload_file";

$backup_file = 'C:/NSAM-Backup/'.$db_server.'/db-ujian_'.date("dmY-hi").'.sql';
// get backup
