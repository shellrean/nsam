...
$tabel = "cbt_jawaban,cbt_kelas,cbt_mapel,cbt_nilai,cbt_paketsoal,cbt_siswa,cbt_siswa_ujian,cbt_soal,cbt_tugas,cbt_ujian,cbt_upload_file";

$backup_file = 'C:/NSAM-Backup/'.$db_server.'/db_'.date("dmY-hi").'.sql';
