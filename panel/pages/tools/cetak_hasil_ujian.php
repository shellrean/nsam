...
<iframe src="<?php echo "cetaknilai.php?kelas=$_REQUEST[iki3]&jur=$_REQUEST[jur3]&mapz=$_REQUEST[map3]"; ?>" style="display:none;" name="frame"></iframe>
		...
		<button type="button" class="btn btn-light btn-sm" onClick="frames['frame'].print()" style="margin-top:4px; margin-bottom:5px"><i class="glyphicon glyphicon-print"></i> Print </button>
		<a href="#" data-toggle="modal" data-target="#myCetakHasil" class="btn btn-success btn-sm">
...
for($i=1;$i<=$n;$i++){ ?>
    ...
    <td rowspan="4" width="150"><img src="../../images/logo-dki.png" width="70"></td>
