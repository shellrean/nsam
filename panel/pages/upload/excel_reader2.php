...
class Spreadsheet_Excel_Reader {
	...
	function Spreadsheet_Excel_Reader($file='',$store_extended_info=true,$outputEncoding='') {
		//$this->_ole =& new OLERead(); //Ada bug error
		//$this->_ole = new OLERead(); //Bisa dipakai dengan menghilangkan & (normal)
		
		$t = new OLERead(); //alternatif code
		$this->_ole =& $t;  //error bisa hilang...
