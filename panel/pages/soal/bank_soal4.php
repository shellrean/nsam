    ...
    <div class="card">
      ...
      <div class="card-body">
		...
		<div class="form-group">
			...
			<select id="txt_ops" name="txt_ops" class="form-control col-md-4">
         ...
         <script>
  			...
  			<tr>
	    		...
	    		<div class="custom-control custom-radio custom-switch">
				  <input type="radio" id="customRadioInline<?= $i ?>" name="radio1" value="<?php echo $i; ?>" class="custom-control-input" <?php if($i==$kuncijwb){echo "checked='checked'";}?>>
    		...
    		<tr>
    			...
    			<td align="right" colspan="2">
    				<textarea name="tanya"  id="jawab<?php echo $i; ?>" style="font-size:18px; width:95%; height:150px">
    					<?php 
						$sql0 = mysql_query("select * from cbt_soal where XKodeSoal= '$_REQUEST[soal]' and Urut = '$_REQUEST[nomer]'");
						$s=mysql_fetch_array($sql0);
						echo "$jawaban"; ?>		
