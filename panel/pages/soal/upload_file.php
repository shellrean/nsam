...
<div class="row">
	<div class="card" style="margin-top:20px; width:95%">
        <div class="card-header" >
			<a href="?modul=file_pendukung" class="btn btn-primary btn-sm">
	...
	<form id="imageform" method="post" enctype="multipart/form-data" action='upload_file_proses.php'>
        ...
        Upload File pendukung soal adalah proses pengcopyan file-file pendukung ke dalam Server,<br>
        proses ini berpengaruh pada sinkronsisasi server sekolah ke server pusat. <br>
		Data file pendukung akan terbentuk hanya bila pengcopyan file ke folder melalui proses Uploading.
		<br>File-file pendukung akan dicopy ke dalam folder-folder pendukung, Extensi File yang suport adalah: 
		<br><br>
