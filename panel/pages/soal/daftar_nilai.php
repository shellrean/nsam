...
$sqlsiswa = mysql_query("select * from cbt_siswa where XNomerUjian= '$user' ");
$sisw = mysql_fetch_array($sqlsiswa);
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
<?php 	
	$sqladmin = mysql_num_rows(mysql_query("select * from cbt_nilai where XNomerUjian= '$user'"));
	if($sqladmin<1){
	...
	$no=1; 	
		...
		$query=mysql_query("SELECT * FROM cbt_nilai where XNomerUjian= '$user'");
	...
	$no=0;
		...
		while($var=mysql_fetch_array($query)){
			...
			$sql = mysql_query("select * from cbt_mapel where XKodeMapel = '$var[XKodeMapel]' ");
